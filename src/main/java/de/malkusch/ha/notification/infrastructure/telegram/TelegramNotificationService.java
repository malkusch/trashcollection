...
final class TelegramNotificationService implements NotificationService {
    ...
    public void send(Notification notification) {
        if (notification instanceof SilentNotification text) {
            send(text);

        } else if (notification instanceof TextNotification text) {
            send(text);
    ...
    private void send(SilentNotification notification) {
